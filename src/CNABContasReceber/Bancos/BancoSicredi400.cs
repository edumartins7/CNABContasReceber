...
namespace CnabContasReceber.Bancos
{
    ...
    public class BancoSicred400 : IBanco
    {
        ...
        public void Detalhe1(StringBuilder b, TituloReceber titulo)
        {
            ...
            b.AppendNumero(4, Math.Round(titulo.CalculaMulta(Opcoes), 2).ToString("#.00", CultureInfo.InvariantCulture)); //93-96
            ...
            b.Append("00"); //157-158
            b.Append("00"); //159-160
            b.AppendNumero(13, Math.Round(titulo.CalculaMora(Opcoes), 2).ToString("#.00", CultureInfo.InvariantCulture)); //161-173
