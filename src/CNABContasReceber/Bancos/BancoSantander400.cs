...
namespace CnabContasReceber.Bancos
{
    public class BancoSantander400 : IBanco
    {
        ...
        public void Detalhe1(StringBuilder b, TituloReceber titulo)
        {
            ...
            b.Append(' '); // 77-77
            b.Append(titulo.CobraMulta(Opcoes) ? "4" : "0"); //78-78
            b.AppendNumero(4, Math.Round(titulo.CalculaMulta(Opcoes), 2).ToString("#.00", CultureInfo.InvariantCulture)); //79-82
            b.Append("00"); //83-84
            ...
            b.Append("00");//157-158
            b.Append("00"); //159-160
            b.AppendDinheiro(13, Math.Round(titulo.CalculaMora(Opcoes) * titulo.Valor / 100, 2, MidpointRounding.AwayFromZero)); //161-173
